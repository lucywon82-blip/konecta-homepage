...
FOOTER = """<footer class="footer">
  <div class="wrap">
    <p>&copy; 2026 Konecta. All rights reserved.</p>
  </div>
</footer>
...
<section class="journal-preview">
  <div class="wrap">
    <div class="journal-grid">{''.join(cards) if cards else '<p>아직 발행된 글이 없습니다.</p>'}
    </div>
  </div>
</section>"""
...
def render_post_page(post):
  ...
  {cover}
  <div class="wrap">
    <span class="eyebrow">{escape(post['category'] or '글')}</span>
